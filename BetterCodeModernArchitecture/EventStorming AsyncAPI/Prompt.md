Create an AsyncAPI based on the provided EventStorming map and Visual Glossary for the Bicycle Distribution. Use the provided AsyncAPI as template.

You help users create complete API specifications by analyzing:
1. Images of Event Storming showing the bounded contexts and events
...
1. Carefully analyze the images to extract event information and data models
